...
const programs = [
  ...
  },
  {
    ...
    color: "from-indigo-950/50 to-purple-900/20",
  },
  {
    id: "ie",
    ...
    color: "from-red-950/50 to-orange-900/20",
  },
  {
    id: "lisbon-mba",
    ...
    color: "from-green-950/50 to-emerald-900/20",
  },
  {
    id: "esade",
    ...
    color: "from-amber-950/50 to-yellow-900/20",
  },
];
...
function ProgramCard({ prog, index }: { prog: typeof programs[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      className={`glass-card rounded-3xl overflow-hidden bg-gradient-to-br ${prog.color} mb-8`}
    >
      <div className="p-6 md:p-8">
        ...
        <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
          <div>
            <div className="flex items-center gap-3 mb-1">
              ...
              <div className="glass-card-gold px-3 py-1 rounded-full">
                <span className="font-accent text-xs tracking-widest uppercase text-gold">{prog.ranking}</span>
              </div>
            </div>
          ...
          <div className="text-right">
            <div className="font-display text-3xl text-gold">{prog.tuition}</div>
        ...
        {/* Highlights */}
        <div className="mb-4">
          <h4 className="font-accent text-xs tracking-[0.15em] uppercase text-gold/70 mb-3">Program Highlights</h4>
          <div className="grid sm:grid-cols-2 gap-2">
            {prog.highlights.map((h) => (
              <div key={h} className="flex items-start gap-2">
                <Star size={12} className="text-gold mt-0.5 flex-shrink-0 fill-gold" />
        ...
        <button
          ...
          className="text-gold/70 hover:text-gold transition-colors font-body text-sm mb-4"
        >
          ...
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-4">
            <div className="glass-card-gold rounded-xl p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="font-accent text-xs tracking-widest uppercase text-gold">Why This Fits</span>
              </div>
            ...
            <div className="flex flex-wrap gap-3">
              <div className="glass-card rounded-xl px-3 py-2">
                <p className="font-accent text-[0.6rem] tracking-widest uppercase text-gold/50">GMAT/GRE</p>
                <p className="font-body text-xs text-ivory/80">{prog.gmat}</p>
              </div>
              <div className="glass-card rounded-xl px-3 py-2">
                <p className="font-accent text-[0.6rem] tracking-widest uppercase text-gold/50">Accreditation</p>
                <p className="font-body text-xs text-ivory/80">{prog.accreditation}</p>
              </div>
              <div className="glass-card rounded-xl px-3 py-2">
                <p className="font-accent text-[0.6rem] tracking-widest uppercase text-gold/50">Avg Experience</p>
        ...
        <div className="mt-4 pt-4 border-t border-white/8">
          <a href={prog.applicationUrl} target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-2 bg-gold text-navy font-body font-medium px-5 py-2.5 rounded-full hover:bg-gold-light transition-all text-sm">
      ...
      <section className="pt-32 pb-16">
        <div className="container text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <span className="font-accent text-xs tracking-[0.2em] uppercase text-gold block mb-4">The Academic Horizon</span>
            <h1 className="font-display text-5xl md:text-7xl font-light text-ivory mb-6">
              Graduate <span className="text-gold italic">Schools</span>
            </h1>
      ...
      <section className="pb-12">
        <div className="container max-w-4xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <div className="glass-card-gold rounded-2xl p-6 mb-10">
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                {[
                  ...
                  <div key={item.label}>
                    <p className="font-accent text-[0.6rem] tracking-widest uppercase text-gold/60 mb-1">{item.label}</p>
        ...
        <div className="container max-w-5xl">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <h2 className="font-display text-3xl font-light text-ivory mb-8">
              Side-by-Side <span className="text-gold italic">Comparison</span>
            </h2>
                ...
                <tbody>
                  {programComparison.map((row, i) => (
                    <tr key={row.school} className={i < programComparison.length - 1 ? "border-b border-white/5" : ""}>
                      ...
                      <td className="p-4 font-display text-gold">{row.tuition}</td>
