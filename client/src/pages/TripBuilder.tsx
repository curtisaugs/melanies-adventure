        ...
        <div className="space-y-4">
          {messages.map((msg, i) => (
            ...
            >
              ...
              >
                {msg.role === "assistant" ? (
                  <div className="[&_ol]:list-decimal [&_ol]:pl-5 [&_ol]:space-y-1 [&_ul]:list-disc [&_ul]:pl-5 [&_ul]:space-y-1 [&_li]:leading-relaxed [&_strong]:font-semibold [&_strong]:text-rose-200 [&_p]:mb-2 [&_p:last-child]:mb-0 [&_h3]:font-semibold [&_h3]:text-rose-200 [&_h3]:mt-3 [&_h3]:mb-1">
